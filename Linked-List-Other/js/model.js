export default class Model{
  ...
  checkData(datum, type){
    ...
    if(type === 'index' && parseInt(datum) > sizeList) return ['danger', `The ${datum} is out of range`]
    if(type === 'index2' && parseInt(datum) >= sizeList) return ['danger', `The ${datum} is out of range`]
